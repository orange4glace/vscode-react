...
import { SplitView, ISplitView } from 'base/browser/ui/splitview/splitview';
...
export class SplitViewView extends React.Component<{splitView: ISplitView}> {
  ...
  render() {
    ...
    return (
      <div>
      <div className={`monaco-split-view2 ${orientation}`}>
        <div className='sash-container'>
          {splitView.sashItems.map(sashItem => sashItem.sash.render())}
        </div>
